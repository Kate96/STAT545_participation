...
- subset with `[`, `[[`, or `$`. 
[1] - want a list that contains a 1st component (ie 1st car of a train)
[[1]] - want contents of the 1st component (of the 1st car)
...
```{r}
str(got_chars, list.len = 4, max.level = 2) #only xth level of lists
str(got_chars[[1]])
```
...
#map_dbl(wesanderson, head(1))
#map(wesanderson, head(1))
